...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_6.setGeometry(QtCore.QRect(30, 40, 201, 16))
        ...
        self.empNumber.setGeometry(QtCore.QRect(260, 40, 113, 26))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_6.setText(_translate("Form", "Введите номер комнаты для удаления"))
